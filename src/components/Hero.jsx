  ...
  return (
    <div className='max-w-[1640px] mx-auto p-4'>
      <div className='max-h-[500px] relative'>
        ...
        bg-black/75 flex flex-col justify-center'>
          <h1 className='px-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl
          font-bold'>O sabor que<span className='text-orange-500'> você merece</span></h1>
          <h1 className='px-4 text-4xl sm:text-5xl md:text-6xl lg:text-7xl
          font-bold'><span className='text-orange-500'>em cada</span>  mordida.</h1>
        </div>
