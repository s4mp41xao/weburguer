    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
      ...
      {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <p className='px-2'>O Seu Dia Começa Aqui</p>
          <button className='border-white bg-white text-black mx-2 absolute bottom-4'>Fazer Pedido</button>
        </div>
        <img 
      ...
      {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Novos Pratos </p>
      ...
      {/* Overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Melhores Sobremesas</p>
          <p className='px-2'>Sabores Personalizados</p>
          <button className='border-white bg-white text-black mx-2 absolute bottom-4'>Fazer Pedido</button>
        </div>
        <img 
        className='max-h-[160px] md:max-h-[200px] w-full object-cover rounded-xl'
