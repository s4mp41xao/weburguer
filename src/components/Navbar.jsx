    ...
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <div className='flex items-center'>
        ...
        <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
          Melhores<span className='font-bold'>Hamburguers</span>
        </h1>
      ...
      <div className='bg-gray-200 rounded-full flex items-center
       px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
        ...
        <input className='bg-transparent p-2 w-full focus:outline-none' type="text" placeholder='Pesquise seu hamburguer' />
      </div>
      {/* Cart Button */}
      ...
      <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0'></div> : ''}
        ...
        {/* Side drawer menu */}
        <div className={nav ? 'fixed top-0 left-0 w-[350px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[350px] h-screen bg-white z-10 duration-300'}>
          <AiOutlineClose onClick={()=> setNav(!nav)} size={30} className='absolute right-4 top-4 cursor-pointer' />
          <h2 className='text-2xl p-4'>Melhores <span className='font-bold'>Hamburguers</span> </h2>
          <nav>
            <ul className='flex flex-col p-4 text-gray-800'>
              ...
              <li className='text-xl py-4 flex'><BsFillSaveFill size={25} className='mr-4 ' />Os melhores</li>
